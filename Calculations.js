/**
* Lösung zu Aufgabe 2, Geosoft 1, SoSe 2020
...
function statechangecallback() {
    ...
    for (i=0; i< t.features.length; i++ ){
        ...
        var inarr = [lagebez, coords, distance, direction];
...
//window.onload = () => {
  ...
  console.log(places);
	...
	places.forEach((place) => {
	   ...
	   const icon = document.createElement('D:\SP_RealityAsABasemap\Bushaltestelle_img');
